...
3. **Command menu visible at prompt:** You do not have to remember even the single letter function calls. These are avaialble right at the command prompt.
...
This is followed by loading of quizme library. Then the `.quizme` repository contaning quiz files is synced with google cloud using:
