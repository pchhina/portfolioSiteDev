...
Simply call `bye()`. This writes the updated QA data to a file in a directory that was created when `make_quiz()` was called. After that, it also removes the data structures related to testing. And you are done. Happy learning!
